...
const validationSchema = Yup.object({
  ...
  // oneOf(products) значение продукта должно быть одним из
  ...
  // дата не обязательное значение и по умолчанию будет текущая дата default(() => new Date())
  wouldRecommend: Yup.boolean().default(false),
  // не обязательное значение по умолчанию false
});
